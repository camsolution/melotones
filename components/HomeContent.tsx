  ...
  return (
    <div>
      <section className="text-center pt-8 sm:pt-16 md:pt-24 pb-4 px-4 relative overflow-hidden">
        ...
        <p className="text-[15px] sm:text-xl text-gray-600 max-w-2xl mx-auto mb-5 sm:mb-10">
          {t(
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-4 sm:mb-10">
          <Link href="/signup" className="btn-primary text-lg px-8 py-3.5 sm:py-4">{t('Essayer maintenant', 'Try now')}</Link>
          <Link href="/login" className="btn-secondary text-lg px-8 py-3.5 sm:py-4">{t('Se connecter', 'Log in')}</Link>
        </div>
      </section>
